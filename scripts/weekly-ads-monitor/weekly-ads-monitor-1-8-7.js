 ...
 * 7. Save the script with a descriptive name like "Weekly Ads Monitor v1.8.7"
 ...
 * Version: 1.8.7 - Enhanced user experience and performance optimizations
 * ====================================
 */
...
function getShowYoyComparison(summarySheet) {
  return summarySheet.getRange('B4').getValue() !== 'Yes';
}
...
function getDateRange() {
  ...
  // Debug: Log the actual dates being calculated
...
function generateWeeklyAdsReport() {
  try {
    Logger.log('Thanks for using Weekly Ad Monitor script by Andrey Kisselev (c) 2025. Version: 1.8.7.');
    ...
    if (SHEET_URL === '') {
      // Create a new spreadsheet if no URL is provided
              spreadsheet = SpreadsheetApp.create('Weekly Ads Monitor v1.8.7 - ' + 
    ...
    Logger.log('🎉 SUCCESS! Weekly Ads Monitor v1.8.7 completed');
